...
def create_matcher_patterns(cpnet_vocab_path, output_path, debug=False):
    """
    Create patterns that will match image/caption/history/question 
    entities with ConceptNet entities

    Parameters
    ----------
    cpnet_vocab_path: str
        Path to conceptnet vocab file.

    output_path: str
        Path to the resulted conceptnet patterns file.
